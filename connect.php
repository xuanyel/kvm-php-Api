...
if ($type == 1 || $type == "1") {  //测试环境
    $url = "qemu+tcp://192.168.1.104/system"; // Libvirt-kvm服务器地址(方法：tcp)
    $aaasasl = array(VIR_CRED_AUTHNAME => "XXXH", VIR_CRED_PASSPHRASE => "XXXH@KvmServer");  //通过sasl认证TCP连接，VIR_CRED_AUTHNAME为sasl2账号，VIR_CRED_PASSPHRASE为sasl2密码（禁止外泄）
